...
fields are asserted before any timing is measured.
...
def main() -> None:
    ...
    print("Preparing the large-message benchmark (DescriptorCache)...\n")
    ...
    print_comparison_table(
        f"Large-message results — DescriptorCache ({N_RECORDS:,} records, "
